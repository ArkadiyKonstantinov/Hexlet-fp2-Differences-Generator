...
const casesSimple = [
  ...
  ['simple1.yml', 'simple2.yaml', 'plane', expectedData[1]],
  ['simple1.json', 'simple2.yaml', 'plane', expectedData[1]],
];
...
const casesNested = [
  ...
  ['nested1.yml', 'nested2.json', 'plane', expectedData[3]],
  ['nested1.yaml', 'nested2.yml', 'plane', expectedData[3]],
];
